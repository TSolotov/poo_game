...
public class WinnerOverlay {
        ...
        public WinnerOverlay(PongPlayer p1, PongPlayer p2, PongPlaying pongPlaying) {
        ...
        public void draw(Graphics g) {
                ...
                g.drawString(p1.getUsername() + " " + p1.getGoals() + " - " + p2.getGoals() + " " + p2.getUsername(),
                                (int) ((FRAME_WIDTH - metrics.stringWidth(p1.getUsername() + p1.getGoals() + " - "
                                                + p2.getGoals() + p2.getUsername())) / 2),
        ...
        public void keyReleased(KeyEvent k) {
                ...
                switch (k.getKeyCode()) {
                        ...
                        case KeyEvent.VK_ENTER:
                                if (p1.getUsername().length() == 0 || p2.getUsername().length() == 0)
                                        break;
                                try (FileWriter writer = new FileWriter(CSVFile.getFileNamePong(), true)) {
                                        CSVFile.writeLine(writer, new String[] { p1.getUsername(),
